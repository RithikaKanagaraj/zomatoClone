  ...
  return (
    <div className='profile-div'>
        <div className='profile-inner-div'>
            ...
            <svg onClick={handleClick} xmlns="http://www.w3.org/2000/svg" fill={styleColor} width="18" height="18" viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img" className="sc-rbbb40-0 iwHbVQ">
