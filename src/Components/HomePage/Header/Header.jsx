        ...
        <div className='head'>
            ...
            <div className='wrapper'>
               <div className='logo-image'>
                ...
                <h1 className='headLine'>Discover the best food & drinks in <span className='span-text'>Coimbatore</span> </h1>
